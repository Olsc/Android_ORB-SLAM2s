...
/// Generic Vocabulary
    ...
    public:
        ...
        /**
         * Loads the vocabulary from memory buffer (binary format)
         * @param data pointer to binary data
         * @param size size of data in bytes
         */
        bool loadFromMemoryBin(const unsigned char* data, size_t size);
...
// --------------------------------------------------------------------------
    ...
    bool TemplatedVocabulary<TDescriptor,F>::loadFromMemoryBin(const unsigned char* data, size_t size)
    {
      ...
      if(m_k<0 || m_k>20 || m_L<1 || m_L>10 || n1<0 || n1>5 || n2<0 || n2>3)
      {
        std::cerr << "Vocabulary loading failure: This is not a correct Binary buffer!" << endl;
        return false;
      }
